  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.placeholder}>
        <Ionicons name="business" size={64} color={colors.data.venues} />
        <Text style={styles.placeholderText}>Venue management coming soon</Text>
        <Text style={styles.placeholderDesc}>View, edit, and moderate all venues</Text>
      </View>
    </SafeAreaView>
  );
}
